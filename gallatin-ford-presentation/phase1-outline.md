# Gallatin Ford — Used Vehicle Presentation · Phase 1 Outline

**For:** Joe Barba, GM
**Speakers:** Rob Lisowski · John McCann
**Built from:** 120-Day Used Vehicle Action Plan (Rev 2.1, Aug 2026) + build brief
**Status:** GATE 1 — awaiting Rob & John review. Nothing built yet.

---

## The five numbers (the only metrics that appear on slides)
...
- Our used front end loses money on every car — on the true basis, with pack, net adds, and CPO incentive money all counted
- The back end already carries the department — fixing the front is pure margin
- Two commitments over 120 days: break-even front gross, and 120 units a month
- Four strategies get us there. None of it is hope — all of it is process

**Speaker notes (Rob):**
- Open with the reporting basis and don't rush it: this −$266 includes pack, net adds, and CPO money. The Daily Operating Report front-gross number is struck before those credits — it understates us, and it's not the number we manage.
- Every used car we sell today is profitable in *total* — F&I is carrying the front end. That's the good news and the problem in one sentence.
- Volume is flat-to-declining while the lot holds. This is a velocity problem, not a supply problem.
- Say it plainly: "we're not asking for money. We're asking for process, and for you to hold us to it."
...
## Slide 2 — Four Strategies
**Speaker: ROB**

### Acquisition. Appraisal. Recon. Leads.

- **Acquisition** — the right cars, from four channels, with a goal on each
- **Appraisal** — one number on the car. No bumping.
- **Recon** — relationship and evidence; stop spending on cars we won't retail
- **Leads & CRM** — the same daily discipline in the CRM that we have in the shop
- The first three fix supply. The fourth sells it. Execute three perfectly and skip the fourth, and we still miss 120.
...
- Don't linger — the four strategy sections make the case. This is the map.
...
## Slide 3 — Acquisition: The Channels
**Speaker: JOHN**

### Four channels. A goal on each.
...
## Slide 4 — Acquisition: Curb Purchases
**Speaker: JOHN**

### $400 to anyone who finds us a car.
...
## Slide 5 — Appraisal: One Number
**Speaker: ROB**

### The desking manager does not appraise.

- A manager off the deal puts one number on the car — the desk never sets it and never sees it set
- No bumping ACVs. A deal made by burying money in the trade doesn't disappear — it comes back later as negative front gross
...
## Slide 7 — Recon: The Relationship
**Speaker: ROB**
...
## Slide 8 — Recon: The KPIs
**Speaker: ROB**

### Time to line: 8.5 → 5.0 days.
...
## Slide 10 — Leads: The Leak
**Speaker: JOHN**

### 59% of our appointments show up.
...
## Slide 11 — Leads: Being In The CRM
**Speaker: JOHN**
...
## Gate 1 notes for Rob & John

1. **Slide count is 12**, per the brief's slide table (the brief's header said ~10; the table lists 12 — the table won).
2. **Number placement:** the five metrics land on slides 1, 8, 9, 10. The **$400** appears on slide 4 because the brief's slide table puts it there — it's a policy term, not a metric. Say the word and it moves to notes.
